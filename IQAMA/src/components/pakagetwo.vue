...
<template>
 <div class="pakagecontainer">
              ...
              <div class="top">
                ...
                <span class="pakagename" style="height: 28PX;">Service Bureau Package</span>
              ...
              <div class="pakagenumber">
                <p class="name">Service Bureau Questions</p>
                <p class="questions"> +500 questions</p>
                <p class="des">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
             <button class="Preview"> <a href="/ServiceBureauPackage">Preview</a></button>
              </div>
...
.Preview {
  ...
  border: none;
  box-shadow: 0.25rem 0.3125rem 0.25rem 0px rgba(0, 0, 0, 1);
  color: #000;
  font-weight: 700;
  font-size: 1rem;
  margin-top: 2rem;
